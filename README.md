...
```
agent：主线先放着，我去吃个饭🍚——这一餐复盘一下刚才那版方案偏没偏，回来接着改。
...
| 任务当下的信号 | 路由到 | 这一餐干什么 |
|---|---|---|
| 下一阶段需要外部信息 | 🍜 检索饭 | 并行搜索补素材（≤5 查询、深读 ≤3 篇） |
| 产出含硬断言（数据/版本/引文） | 🔍 核查饭 | 逐条交叉验证，标 ✅确认/⚠️存疑/❌推翻 |
| 刚完成一个阶段 | 🥗 复盘饭 | 对照目标：做完了什么/偏航没/漏了什么 |
| 下一阶段不明朗、优先级不清 | 🍱 规划饭 | 拆下一步：顺序/依赖/风险/验收标准 |
| 连续高强度但无明显单一缺口 | 🍚 复盘+规划套餐 | 先复盘对齐，再定下三步（零外部依赖） |
